...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Documents" Type="Folder">
			<Item Name="Operators Manual.pdf" Type="Document" URL="../../Documents/Operators Manual.pdf"/>
			<Item Name="Programmers Manual.pdf" Type="Document" URL="../../Documents/Programmers Manual.pdf"/>
		</Item>
		<Item Name="6700C.lvlib" Type="Library" URL="../6700C.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="6700C" Type="Packed Library">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{3FF44EDC-A6C6-4F5E-9D1B-BB0096AC0448}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">N6700C Driver Child class.  

This overrides the parent method to perform the specific command structures necessary to control the N6700.
The Power Supply class is the class that should be used for development.  This class is the concrete implementation of override methods.</Property>
				<Property Name="Bld_buildSpecName" Type="Str">6700C</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{A38BA8DB-7D93-4E82-914C-0CDFF7900206}</Property>
				<Property Name="Bld_version.build" Type="Int">2</Property>
				<Property Name="Bld_version.major" Type="Int">3</Property>
				<Property Name="Destination[0].destName" Type="Str">6700C.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{70C55F19-9C24-44AE-9213-B1AF46FC3D3C}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/6700C.lvlib</Property>
...
v0.2.2.1 - Implemented 6700C GUI
v0.2.2.0 - Modified GUI RE-entrancy settings
v0.2.1.9 - Resolved Voltage and Current Maximums
v0.2.1.4 - Added Channel Create Override
v0.2.1.3 - Added Read All Measured override and data channel config in connect routines
v0.2.1.2 - Cleared settings updates in measurement routines.  This was causing a persistent settings conflict in the software.  
v0.2.1.1 - Added Current and Voltage Output Validation
v0.2.1.0 - Changed connect routine to allow multiple session creation via TCPIP
v2.0.0.0 - Updated to LV 2019- Enable PPL access for future LV versions
v1.1.0.1 - Added defaukt operation for non supported query and send settings functions
v1.1.0.0 - Updated to LV 2017
V1.0.0.4 - Found &amp; added Voltage Slew rate control capabilities.
V1.0.0.3 - Parent Rebuild Required child rebuild.
V1.0.0.2 - Enabled debugging - I didn't realize I had it disabled.
V1.0.0.1 - Added Self Test &amp; Replaced controls &amp; indicators with silver controls and indicators.
v1.0.0.0 - Initial release - Utilizing N6700 drivers from Agilent
v0.0.0.1 - Non-released software version.  Used for behavioral validation.</Property>
				<Property Name="TgtF_internalName" Type="Str">6700C</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2019 JPL</Property>
				<Property Name="TgtF_productName" Type="Str">6700C</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{DAF0548A-2CB3-4F40-94D6-1F877F831EBA}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">6700C.lvlibp</Property>

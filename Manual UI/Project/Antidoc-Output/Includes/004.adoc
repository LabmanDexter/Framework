...
|Send Close Instruments
|image:Manual_UI.lvlib_Close_Instruments_Msg.lvclass_Send_Close_Instruments.vi.png[Manual UI.lvlib:Close Instruments Msg.lvclass:Send Close Instruments.vi]
...
|Do
|image:Manual_UI.lvlib_Close_Instruments_Msg.lvclass_Do.vi.png[Manual UI.lvlib:Close Instruments Msg.lvclass:Do.vi]

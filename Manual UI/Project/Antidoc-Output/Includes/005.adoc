...
|Send Launch Instruments
|image:Manual_UI.lvlib_Launch_Instruments_Msg.lvclass_Send_Launch_Instruments.vi.png[Manual UI.lvlib:Launch Instruments Msg.lvclass:Send Launch Instruments.vi]
...
|Do
|image:Manual_UI.lvlib_Launch_Instruments_Msg.lvclass_Do.vi.png[Manual UI.lvlib:Launch Instruments Msg.lvclass:Do.vi]

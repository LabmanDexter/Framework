...
|Send Query Instruments
|image:Manual_UI.lvlib_Query_Instruments_Msg.lvclass_Send_Query_Instruments.vi.png[Manual UI.lvlib:Query Instruments Msg.lvclass:Send Query Instruments.vi]
...
|Do
|image:Manual_UI.lvlib_Query_Instruments_Msg.lvclass_Do.vi.png[Manual UI.lvlib:Query Instruments Msg.lvclass:Do.vi]
